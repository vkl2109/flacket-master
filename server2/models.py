...
class Booking(db.Model):
    ...
    def toJSON(self):
        ...
        return {"id": self.id, "start_time": event.start_time.strftime("%m/%d/%Y, %H:%M:%S"), "end_time": event.end_time.strftime("%m/%d/%Y, %H:%M:%S"), "seat_number": seat.seat_number, "event": event.name, "classroom": classroom.name}
